...
- **Explorer context menu** — right-click any folder to open it in VerBump directly;
  ...
  Both options are available as optional entries during installation.
...
- **Command-line arguments**
  - `VerBump.exe <path>` — open VerBump with a specific `VERSION` file or folder
    pre-selected
...
- **Explorer-Kontextmenü** — Rechtsklick auf einen Ordner öffnet VerBump direkt;
  ...
  Beide Optionen sind während der Installation optional wählbar.
